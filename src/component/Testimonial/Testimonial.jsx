...
const reviewData = [
    {
      ...
      message: "Get a fully retina-ready site when you build with Startup Framework. Websites look sharper and more gorgeous on devices with retina display.",
      name: "John Smith",
    },
    {
...
const Testimonial = () => {
  return (
    <div className="max-w-[1000px] mx-auto font-ageo my-[100px]">
      <SectionTitle section="Testimonial" title="What client say about us" />
    ...
    reviewData.map((review, i) =>(
        <div key={i} className="flex flex-col sm:flex-row gap-[20px] items-start w-full max-w-[450px]">
            ...
            <div className="text-left">
                <p className="text-base leading-6 text-[#333] tracking-wide  mb-2">{review?.message}</p>
